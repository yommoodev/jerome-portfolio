            ...
            <div data-aos="fade-down-left" data-aos-duration="1000" className="max-w-[694px] w-full flex flex-col gap-4 lg:gap-[32px] ">
                ...
                <div className="w-full lg:max-w-[79%]">
                    <p className="text-white lg:text-start md:text-center leading-[1.5]">
                        Hello! I'm Jerome Canolang, a <span className='font-bold'>Frontend Developer</span> specializing in modern web development with <span className="font-bold">React,</span> <span className="font-bold">Node.js,</span> <span className="font-bold">Firebase and more</span>. <br/>
                        I build responsive and efficient interfaces, ensuring optimal performance and user satisfaction. 
                        Explore my projects to see how I leverage cutting-edge technologies to solve real-world problems.
                    </p>
